                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="{{ asset('BRAND2.png') }}" width="180" alt="">
                                </a>
                                <form method="POST" action="{{ route('login') }}">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <button type="submit"
                                        class="btn btn-danger w-100 py-8 fs-4 mb-4 rounded-2">Masuk</button>
                                    <a type="button" href="{{ route('home') }}"
                                        class="btn btn-dark w-100 py-8 fs-4 mb-4 rounded-2">Kembali</a>
                                </form>
                            </div>
                        </div>
                    </div>
